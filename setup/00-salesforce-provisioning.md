...
- **Steps:**
  ...
  2. Create a **permission set** (e.g. `D360 POC HCP Segment Access`) granting the Data 360 **system
     ...
     [dataModel-dev.yaml](../reference/dataModel-dev.yaml). Leave PII fields off unless a count genuinely needs
...
| **DMOs / data model** | The HCP DMOs exist and are mapped in [dataModel-dev.yaml](../reference/dataModel-dev.yaml); verify + flip `VERIFY → verified` | Data Cloud Architect |
